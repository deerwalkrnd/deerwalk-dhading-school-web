...
import Data from "@/_components/Administration/Data";
...
const AdministrationCard: React.FC<FacultyCardProps> = ({
  name,
  image,
  description,
  linkedIn,
  ...
  return (
    <div className="flex flex-row flex-wrap gap-10 text-[#2E2E2E]">
