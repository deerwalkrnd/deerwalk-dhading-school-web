    ...
    <div className="flex flex-col w-full gap-20">
      <div className="flex flex-col justify-center items-center lg:flex-row gap-20 px-4 sm:px-10 lg:px-20">
        ...
        <EventsCard
          ...
          heading="Deerwalk Poetry & Debate Championship"
      ...
      <div className="flex flex-col justify-center items-center lg:flex-row gap-20 px-4 sm:px-10 lg:px-20">
        ...
        <EventsCard
          ...
          heading="All Nepal Poetry Championship"
        ...
        <EventsCard
          ...
          heading="District Mathematics Olympiad"
