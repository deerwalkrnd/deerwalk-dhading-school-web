...
export default function BodyCard() {
  return (
    <div className="flex flex-col  gap-20">
      <div className="flex flex-col flex-wrap justify-center items-center lg:flex-row gap-20 px-4 sm:px-10 lg:px-20">
        <EventsCard
        ...
        <EventsCard
          ...
          description="We are delighted to report the successful hosting of Parents Talk session on Ashwin 2. This event invited parents to share motivational lectures, struggles, and successes.
          We were honored to have Mr. Shekhar Karki lead this month's session and share his experiences and life stories. It was a memorable event that achieved its objective of inspiring and guiding our students"
        />
        <EventsCard
          image={SportsMeet1}
          heading="DDS Sports Meet Day 1"
